---
title: vaara clothing print
type: sample_code
objects: Part, Line, Field
source: vaara clothing print.txt
---

# vaara clothing print
	...
	[Line: VaaraPlaceOfSupply]
		...
		[Field:VaaraPlaceOfSupply]
			...
			[Field:VaaraPlaceOfSupply1]
				Set as		: #VAaraCustState;$BasicFinalDestination;$PriorStateName:Ledger:$PartyLedgerName  + "-" + $$getgststatecode:($LedStateName:Ledger:$PartyLedgerName )
				Style		: TimesBold12
				Full Width	: Yes
...
[Part:ItemDtlsPartVaara]
	...
	[Line:ItemDtlsPartVaara]
		Fields	: SINoVaaraB, DesignNoVaaraB,SizeVaaraB, RateVaaraB,DiscountVaaraB, NRateVaaraB, GstVaaraB, QuantityVaaraB, AmountVaaraB
		Space Top	: 0.5
		[Field:SINoVaaraB]
			Width	: 5% Page
			Set as	: $$Line
	...
	[Line:GStPartBottomVaara]
		...
		[Field:GStPartBottomVaaraAmtB]
			...
			[Field:GStPartBottomVaaraAmtB2]
				;Set as		:  If NOT( $$IsEqual:($$String:#VaaraInvNo):($$String:$VchNumber1)) Then "" Else $ValAmount;$Amount
...
[Part:TotalBottomVaara]
	Line	: TAmountVaara, TAmountVaara1, TotalAmountVaara
	Width	: 25% Page
	Border	: Thin Left
	Common Border	: Yes
	[Line:TAmountVaara]
	...
	[Line:TotalAmountVaara]
		Fields	: TotalAmountVaaraTitle, TotalAmountVaaraAmt
		[Field:TotalAmountVaaraTitle]
			Align	: Center
			Width	: 15% Page
			Set as	: "TOTAL"
			
		[Field:TotalAmountVaaraAmt]
			Set as	: $$CollAmtTotal:InventoryEntries:$Amount
			Width	: 10% Page
			Align	: Right
			Border	: Thin Left
...
[Part:NetTotalVaara]
	Line	: GStLedgerVaara
	Repeat	: GStLedgerVaara	: LedgerEntries
	Width	: 25% Page
	Border	: Thin Left
	Common Border	: Yes
	[Line:GStLedgerVaara]
...
[Part:DeclarationVaara]
	...
	Space Bottom	: 0.2
	Space Top		: 0.2
	Lines			: DelarationVaaraBase;DeclarationVaara1, DeclarationVaara2, DeclarationVaara3, DeclarationVaara4, DeclarationVaara5
	Border			: Thin Right
	;
	...
	[Line:DelarationVaaraBase]
		...
		[Field:DelarationVaaraBase]
			Set as		: "Certified that the particulars given above are true & correct & the amount indicated represents the price actually charged & there is no flow of additional consideration directly or indirectly from the buyers."
			Lines		: 0
			Full Width	: Yes
			Style		: ArialNormal7
/*	[Line:DeclarationVaara1]
		Field	: DeclarationVaara1
		[Field:DeclarationVaara1]
			Set as		: "Certified that the particulars given above"
			Full Width	: Yes
			Style		: ArialNormal8
			
	[Line:DeclarationVaara2]
		Field	: DeclarationVaara2
		[Field:DeclarationVaara2]
			Set as		: "are true& correct & the amount indicated"
			Full Width	: Yes
			Style		: ArialNormal8
			
	[Line:DeclarationVaara3]
		Field	: DeclarationVaara3
		[Field:DeclarationVaara3]
			Set as		: "represents the price actually charged &"
			Full Width	: Yes
			Style		: ArialNormal8
			
	[Line:DeclarationVaara4]
		Field	: DeclarationVaara4
		[Field:DeclarationVaara4]
			Set as		: "there is no flow of additional consideration "
			Full Width	: Yes
			Style		: ArialNormal8
			
	[Line:DeclarationVaara5]
		Field	: DeclarationVaara5
		[Field:DeclarationVaara5]
			Set as		: "directly or indirectly from the buyers."
			Full Width	: Yes
			Style		: ArialNormal8
...
[Line:EXPINV BankBranchInfoIFS]
	...
	/*
	Lines		: BankVaara, BranchVaara, AcVaara, IfscVaara
	
	[Line:BankVaara]
		Fields	: Vaara Prompt, BankVaara
		Local: Field: Vaara Prompt	:Info	: $$LocaleString:"OUR BANK"
;		[Field:Vaara Prompt]
;			
;			Style	: ArialBold12
;			Width	: 15
...
;			Fixed   : Yes
	...
	[Line:BranchVaara]
		Use		: BankVaara
		Local	: Field	: Vaara Prompt	: Info		: $$LocaleString:"BRANCH"
		Local	: Field	: BankVaara		: Set as	: $BankBranchName:Ledger:"HDFC Bank A/c"

	[Line:AcVaara]
		Use		: BankVaara
		Local	: Field	: Vaara Prompt	: Info		: $$LocaleString:"A/C NO."
		Local	: Field	: BankVaara		: Set as	: $BankDetails:Ledger:"HDFC Bank A/c"

	[Line:IfscVaara]
		Use		: BankVaara
		Local	: Field	: Vaara Prompt	: Info		: $$LocaleString:"IFSC CODE"
		Local	: Field	: BankVaara		: Set as	: $IFSCode:Ledger:"HDFC Bank A/c"
